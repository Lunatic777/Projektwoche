<?php
	...
	if (empty($_SESSION['email'])) {$_SESSION['status'] = 51;}
	elseif (empty($_SESSION['message'])){$_SESSION['status'] = 52;}
	elseif (!preg_match('/^[A-Za-z0-9._%-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/',$_POST['email'])){$_SESSION['status'] = 53;}
	else {
